...
public class ContainerManaManager extends Container {

	public ContainerManaManager(InventoryPlayer invPlayer, TileEntityManaManager manager) {
		for (int x = 0; x < 9; x++) {
		...
		addSlotToContainer(new SlotIMana(manager, 5, 71, 62));
