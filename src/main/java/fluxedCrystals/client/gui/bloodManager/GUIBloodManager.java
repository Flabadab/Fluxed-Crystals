...
public class GUIBloodManager extends GuiContainer {

	private TileEntityBloodManager tile;

	public GUIBloodManager(InventoryPlayer invPlayer, TileEntityBloodManager tile2) {
		super(new ContainerBloodManager(invPlayer, tile2));
	...
	public void actionPerformed(GuiButton button) {
		...
		case 0:
			if (!tile.canPlacePowerBlocks()) {
				...
				PacketHandler.INSTANCE.sendToServer(new MessageBloodManager(tile.xCoord, tile.yCoord, tile.zCoord, 1));
			}
			break;
		case 1:
			if (!tile.canPlacePowerBlocks()) {
				...
				PacketHandler.INSTANCE.sendToServer(new MessageBloodManager(tile.xCoord, tile.yCoord, tile.zCoord, 2));
			}
			break;
		...
		case 2:
			if (!tile.canPlacePowerBlocks()) {
				...
				PacketHandler.INSTANCE.sendToServer(new MessageBloodManager(tile.xCoord, tile.yCoord, tile.zCoord, 3));
			}
			break;
		case 3:
			if (!tile.canPlacePowerBlocks()) {
				...
				PacketHandler.INSTANCE.sendToServer(new MessageBloodManager(tile.xCoord, tile.yCoord, tile.zCoord, 4));
			}
			break;
