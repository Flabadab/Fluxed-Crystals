...
public class ContainerIndustrialManager extends Container {

	public ContainerIndustrialManager(InventoryPlayer invPlayer, TileEntityIndustrialManager manager) {
		for (int x = 0; x < 9; x++) {
